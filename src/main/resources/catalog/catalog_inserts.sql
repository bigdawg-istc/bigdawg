...
-- insert into catalog.engines values(5,'postgres_codd8','codd08',5432,'PostgreSQL 9.4.5');
-- insert into catalog.engines values(6,'postgres_codd9','codd09',5432,'PostgreSQL 9.4.5');
...
insert into catalog.databases values(6,2,'scidb_local','scidb','scidb123');
-- insert into catalog.databases values(7,0,'genbase','pguser','test');
-- insert into catalog.databases values(8,1,'genbase','pguser','test');
-- insert into catalog.databases values(9,3,'codd07','scidb','scidb123');
-- insert into catalog.databases values(10,4,'codd06','scidb','scidb123');
