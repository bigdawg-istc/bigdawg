...
TypeAttributeMap::TypeAttributeMap() {
    ...
    typeAttributeMap.insert(std::make_pair("bool",std::make_shared<GenericAttribute<bool> >(false)));
    typeAttributeMap.insert(std::make_pair("bool"+nullString,std::make_shared<GenericAttribute<bool> >(true)));
