 ...
 */
int Postgres2Csv::postgres2csv(const std::string & inputCsv, std::vector<std::shared_ptr<Attribute> > & attributes, const std::string & outputCsv) {
 ...
 */
int Postgres2Csv::postgres2csv(FILE* in, std::vector<std::shared_ptr<Attribute> > & attributes, const std::string & csvFileName) {
