 ...
 * @author Kate Yu
 */
public class VerticaConnectionInfo implements ConnectionInfo {
    ...
    public VerticaConnectionInfo(String host, String port, String database,
    ...
    public String getUrl() {
        return "jdbc:vertica://" + getHost() + ":" + getPort() + "/"
                + getDatabase();
    }

    public static String getUrl(String host, String port, String database) {
        return "jdbc:vertica://" + host + ":" + port + "/" + database;
    }
    ...
    /**
     * This is a specific property forVertica database.
     *
    ...
    public long[] computeHistogram(String object, String attribute,
        ...
        List<List<String>> raw = ((JdbcQueryResult) new VerticaHandler(this)
    ...
    public Pair<Number, Number> getMinMax(String object, String attribute)
        ...
        List<String> raw = ((JdbcQueryResult) new VerticaHandler(this)
    ...
    public ExecutorEngine getLocalQueryExecutor() {
        return new VerticaHandler(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof VerticaConnectionInfo))
            return false;
        VerticaConnectionInfo other = (VerticaConnectionInfo) obj;
        if (database == null) {
