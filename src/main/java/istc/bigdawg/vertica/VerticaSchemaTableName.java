 ...
 * @author Kate Yu
 */
public class VerticaSchemaTableName implements RelationalSchemaTableName {
     ...
     */
    public VerticaSchemaTableName(String tableNameInitial) {
     ...
     * @param tableName
     */
    public VerticaSchemaTableName(String schemaName, String tableName) {
