...
class JDBCExample {
	public static void main(String[] args) throws IOException {
		...
		try {
			Connection conn = DriverManager.getConnection("jdbc:scidb://codd07/");
...
//			conn.commit();
			...
			ResultSet res = st.executeQuery("select * from " + " region where region.r_name = 'AMERICA' or region.r_name = 'ASIA'");
