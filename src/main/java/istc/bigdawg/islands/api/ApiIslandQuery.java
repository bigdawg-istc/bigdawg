...
public class ApiIslandQuery extends IntraIslandQuery {
    ...
    public ApiIslandQuery(String islandQuery, String name, Map<String, String> transitionSchemas)
            throws Exception {
        ...
        Island thisIsland = IslandAndCastResolver.getIsland(Scope.API);
