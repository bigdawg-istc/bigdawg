...
public class ApiOperator implements Operator {

    static final String subtreeToken = "BIGDAWGAPISUBTREE_";
    static final String pruneToken = "BIGDAWGAPIPRUNED_";
...
//	}
    ...
    public Operator duplicate(boolean addChild) throws IslandException {
        throw new IslandException("ApiOperator: duplicate not implemented; class: "+this.getClass());
    }

    @Override
    public Map<String, String> getDataObjectAliasesOrNames() throws IslandException {
        throw new IslandException("ApiOperator: getDataObjectAliasesOrNames not implemented; class: "+this.getClass());
    }

    @Override
    public void removeCTEEntriesFromObjectToExpressionMapping(Map<String, Set<String>> entry) throws IslandException {
        throw new IslandException("ApiOperator: removeCTEEntriesFromObjectToExpressionMapping not implemented; class: "+this.getClass());
    }

    @Override
    public String getTreeRepresentation(boolean isRoot) throws IslandException {
        throw new IslandException("ApiOperator: getTreeRepresentation not implemented; class: "+this.getClass());
    }
    ...
    public void accept(OperatorQueryGenerator operatorQueryGenerator) throws Exception {
        throw new ShimException("ApiOperator: accept not implemented; class: "+this.getClass());
    }
