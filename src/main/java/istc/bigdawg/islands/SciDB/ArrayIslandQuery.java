...
public class ArrayIslandQuery extends IntraIslandQuery {
...
//	private Operator initialRoot;
	...
	public ArrayIslandQuery(String islandQuery, String name, Map<String, String> transitionSchemas)
			throws Exception {
		super(Scope.ARRAY, islandQuery, name, transitionSchemas);
		...
		// optimize it by permuting
		ArrayIslandPermuter.optimize(this);
