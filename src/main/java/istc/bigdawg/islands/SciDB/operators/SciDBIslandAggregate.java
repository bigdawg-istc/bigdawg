...
//	SciDBIslandAggregate(Map<String, String> parameters, List<String> output, SciDBIslandOperator child, SQLTableExpression supplement) throws Exception  {
...
//				out);
	...
	public Map<String, Expression> getChildrenPredicates() throws Exception {
		Map<String, Expression> ret = ((SciDBIslandOperator)this.getChildren().get(0)).getChildrenPredicates();
