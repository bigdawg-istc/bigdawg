 ...
 * 
 */
public class FromSStoreToPostgres2 extends FromDatabaseToDatabase {

	/*
	 * log
	 */
	private static Logger logger = Logger
			.getLogger(FromSStoreToPostgres2.class);
	...
	public FromSStoreToPostgres2(SStoreSQLConnectionInfo connectionFrom,
	...
	public static void main(String[] args) throws Exception {
		...
		FromDatabaseToDatabase migrator = new FromSStoreToPostgres2(
