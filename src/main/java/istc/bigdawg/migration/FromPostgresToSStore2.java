 ...
 * 
 */
public class FromPostgresToSStore2 extends FromDatabaseToDatabase {

	/*
	 * log
	 */
	private static Logger logger = Logger
			.getLogger(FromPostgresToSStore2.class);
	...
	public FromPostgresToSStore2(PostgreSQLConnectionInfo connectionFrom,
...
//			countLoadedElements = (Long) loadTask.get();
	...
	public static void main(String[] args) throws Exception {
		...
		ConnectionInfo conInfoTo = new SStoreSQLConnectionInfo("localhost",
				"21212", "", "user", "password");
		FromDatabaseToDatabase migrator = new FromPostgresToSStore2(
