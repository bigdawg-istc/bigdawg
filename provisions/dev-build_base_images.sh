...
echo "==> postgres"
docker build --rm -t bigdawg/postgres-dev postgres/

echo "==> scidb"
docker build --rm -t bigdawg/scidb-dev scidb/

echo "==> accumulo"
docker build --rm -t bigdawg/accumulo-base-dev docker-builds/accumulo/
docker build --rm -t bigdawg/accumulo-dev accumulo/

echo "==> pushing images to dockerhub"
docker push bigdawg/postgres-dev
docker push bigdawg/scidb-dev
docker push bigdawg/accumulo-base-dev
docker push bigdawg/accumulo-dev
