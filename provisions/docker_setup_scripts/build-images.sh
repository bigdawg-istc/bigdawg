...
# copy necessary files for postgres_dev
cp -a src/main/resources/catalog provisions/postgresdev/
cp -a src/main/resources/monitor provisions/postgresdev/
cp -a src/main/resources/schemas provisions/postgresdev/
cp -a src/main/resources/create_logs_table.sql provisions/postgresdev/
