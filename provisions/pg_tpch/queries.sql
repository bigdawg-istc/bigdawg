-- using 1490210319 as a seed to the RNG
-- using 1490210584 as a seed to the RNG
\timing on
\o /dev/null
set schema 'tpch';
...
order by
	revenue desc
LIMIT 20;-- using 1490210584 as a seed to the RNG
...
order by
	value desc
LIMIT 1;-- using 1490210584 as a seed to the RNG
...
drop view revenue0;-- using 1490210584 as a seed to the RNG
...
where
	...
	and p_size in (41, 1, 39, 46, 13, 8, 23, 32)
...
order by
	o_totalprice desc,
	o_orderdate
LIMIT 100;-- using 1490210584 as a seed to the RNG
...
order by
	revenue desc,
	o_orderdate
LIMIT 10;-- using 1490210584 as a seed to the RNG
