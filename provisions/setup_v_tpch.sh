...
docker exec bigdawg-postgres-catalog /bdsetup/setup_tpch.sh catalog_inserts_v_tpch.sql
...
# postgres-data on postgres-catalog 
#docker cp cluster_setup/postgres-tpch/bdsetup/setup.sh bigdawg-postgres-catalog:/bdsetup/setup_tpch.sh
#docker cp pg_tpch bigdawg-postgres-catalog:/bdsetup/
#docker cp tpch-data bigdawg-postgres-catalog:/bdsetup/pg_tpch
#docker exec --user=root bigdawg-postgres-catalog /bdsetup/setup_tpch.sh
