...
insert into catalog.engines values(1,'postgres1','bigdawg-postgres-tpch',5401,'PostgreSQL 9.4.5');
insert into catalog.engines values(2,'vertica','bigdawg-vertica-tpch',5433,'Vertica');
...
select setval('catalog.engines_eid_seq'::regclass, 2);
...
insert into catalog.databases values(2,1,'tpch','pguser','test');
insert into catalog.databases values(3,2,'docker','dbadmin','');
...
select setval('catalog.databases_dbid_seq'::regclass, 3);
...
select setval('catalog.catalog.shims_shim_id_seq'::regclass, 2);
...
insert into catalog.objects values(2, 'nation', 'n_nationkey,n_name,n_regionkey,n_comment', 2, 3);
insert into catalog.objects values(3, 'orders', 'o_orderkey,o_custkey,o_orderstatus,o_totalprice,o_orderdate,o_orderpriority,o_clerk,o_shippriority,o_comment', 2, 3);
insert into catalog.objects values(4, 'part', 'p_partkey,p_name,p_mfgr,p_brand,p_type,p_size,p_container,p_retailprice,p_comment', 2, 3);
insert into catalog.objects values(5, 'partsupp', 'ps_partkey,ps_suppkey,ps_availqty,ps_supplycost,ps_comment', 2, 2);
insert into catalog.objects values(6, 'region', 'r_regionkey,r_name,r_comment', 2, 3);
insert into catalog.objects values(7, 'supplier', 's_suppkey,s_name,s_address,s_nationkey,s_phone,s_acctbal,s_comment', 2, 3);
